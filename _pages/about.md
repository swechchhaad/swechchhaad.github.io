...
I’m interested in both theoretical and applied post-quantum cryptography. Currently I am evaluating Utah's new State-Endorsed Digital Identity [(SEDI)](https://sedi.utah.gov/) framework from a cryptography and privacy perspective, under the supervision of [Kent Seamons](https://cs.byu.edu/department/directories/faculty-directory/kent-seamons/).
